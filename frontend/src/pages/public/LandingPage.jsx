    ...
    <div className="space-y-24 pb-20 overflow-hidden">
      ...
      <section className="relative pt-12 sm:pt-20 lg:pt-28">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 mt-14 sm:mt-20">
          <div className="relative rounded-3xl border-2 border-indigo-200/90 dark:border-slate-800 bg-white/95 dark:bg-[#111827] backdrop-blur-xl p-4 sm:p-6 shadow-2xl shadow-indigo-500/15 dark:shadow-brand-950/40 ring-4 ring-indigo-500/5 dark:ring-0">
            {/* Top Mock Window Bar */}
            <div className="flex items-center justify-between pb-3 mb-5 border-b border-slate-200/80 dark:border-slate-800/80 text-xs text-slate-600 dark:text-slate-400 font-medium">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              <div className="p-5 rounded-2xl bg-gradient-to-br from-indigo-100/90 via-indigo-50/50 to-white dark:from-slate-900/90 dark:via-slate-900 dark:to-slate-900 border-2 border-indigo-200 dark:border-slate-800 shadow-md shadow-indigo-500/5 hover:border-indigo-400 dark:hover:border-indigo-600 transition-all flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between gap-2 mb-2">
                    <span className="text-[11px] text-indigo-950 dark:text-indigo-300 font-extrabold uppercase tracking-wider">Total Balance</span>
              ...
              <div className="p-5 rounded-2xl bg-gradient-to-br from-emerald-100/90 via-emerald-50/50 to-white dark:from-slate-900/90 dark:via-slate-900 dark:to-slate-900 border-2 border-emerald-200 dark:border-slate-800 shadow-md shadow-emerald-500/5 hover:border-emerald-400 dark:hover:border-emerald-600 transition-all flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between gap-2 mb-2">
                    <span className="text-[11px] text-emerald-950 dark:text-emerald-300 font-extrabold uppercase tracking-wider">Green View Mess Net</span>
                ...
                <div className="text-xs text-emerald-900 dark:text-slate-400 mt-3 font-bold">3 roommates owe you</div>
              </div>

              <div className="p-5 rounded-2xl bg-gradient-to-br from-amber-100/90 via-amber-50/50 to-white dark:from-slate-900/90 dark:via-slate-900 dark:to-slate-900 border-2 border-amber-200 dark:border-slate-800 shadow-md shadow-amber-500/5 hover:border-amber-400 dark:hover:border-amber-600 transition-all flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between gap-2 mb-2">
                    <span className="text-[11px] text-amber-950 dark:text-amber-300 font-extrabold uppercase tracking-wider">Food Budget Used</span>
                ...
                <div className="text-xs text-amber-900 dark:text-amber-400 font-extrabold mt-3">৳5,100 left of ৳12,000</div>
              </div>

              <div className="p-5 rounded-2xl bg-gradient-to-br from-sky-100/90 via-sky-50/50 to-white dark:from-slate-900/90 dark:via-slate-900 dark:to-slate-900 border-2 border-sky-200 dark:border-slate-800 shadow-md shadow-sky-500/5 hover:border-sky-400 dark:hover:border-sky-600 transition-all flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between gap-2 mb-2">
                    <span className="text-[11px] text-sky-950 dark:text-sky-300 font-extrabold uppercase tracking-wider">MacBook Pro Goal</span>
                ...
                <div className="text-xs text-sky-950 dark:text-slate-400 mt-3 font-bold">৳195,000 of ৳280,000</div>
              </div>
            </div>

            {/* Split & Debt Simplification Visualizer Card */}
            <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-r from-violet-100/80 via-indigo-50/70 to-purple-100/80 dark:from-slate-900/90 dark:via-slate-900 dark:to-slate-900 border-2 border-indigo-200/90 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6 shadow-md">
              ...
              <div className="flex flex-col gap-2.5 w-full md:w-auto">
                <div className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-white dark:bg-slate-800/90 border-2 border-emerald-300 dark:border-emerald-800 text-xs font-mono shadow-sm">
                  <span className="font-extrabold text-slate-900 dark:text-white">Karim</span>
                  <span className="text-brand-600 dark:text-brand-400 font-black">&rarr;</span>
                  ...
                  <span className="text-[10px] bg-emerald-100 dark:bg-emerald-950 text-emerald-800 dark:text-emerald-300 px-2 py-0.5 rounded-md font-bold font-sans">Settled</span>
                </div>
                <div className="flex items-center gap-3 px-4 py-2.5 rounded-xl bg-white dark:bg-slate-800/90 border-2 border-amber-300 dark:border-amber-800 text-xs font-mono shadow-sm">
                  <span className="font-extrabold text-slate-900 dark:text-white">Hasan</span>
                  <span className="text-brand-600 dark:text-brand-400 font-black">&rarr;</span>
                  <span className="font-extrabold text-emerald-700 dark:text-emerald-400">Rafi</span>
                  <span className="font-black ml-auto text-amber-700 dark:text-amber-400">৳3,500.00</span>
                  <span className="text-[10px] bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-300 px-2 py-0.5 rounded-md font-bold font-sans">Pending</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="rounded-3xl border-2 border-emerald-300 dark:border-slate-800 bg-gradient-to-b from-emerald-100/70 via-emerald-50/40 to-white dark:from-[#111827] dark:via-[#111827] dark:to-[#111827] p-8 space-y-6 shadow-xl shadow-emerald-500/10 hover:shadow-2xl hover:border-emerald-400 dark:hover:border-emerald-700 transition-all">
            ...
            <ul className="space-y-3 text-sm text-slate-800 dark:text-slate-300 font-medium">
              <li className="flex items-center gap-3 p-3 rounded-xl bg-white/90 dark:bg-slate-800/70 border border-emerald-200 dark:border-slate-800 shadow-sm text-slate-800 dark:text-slate-200">
          ...
          <div className="rounded-3xl border-2 border-indigo-300 dark:border-slate-800 bg-gradient-to-b from-indigo-100/70 via-indigo-50/40 to-white dark:from-[#111827] dark:via-[#111827] dark:to-[#111827] p-8 space-y-6 shadow-xl shadow-indigo-500/10 hover:shadow-2xl hover:border-indigo-400 dark:hover:border-indigo-700 transition-all">
            ...
            <ul className="space-y-3 text-sm text-slate-800 dark:text-slate-300 font-medium">
              <li className="flex items-center gap-3 p-3 rounded-xl bg-white/90 dark:bg-slate-800/70 border border-indigo-200 dark:border-slate-800 shadow-sm text-slate-800 dark:text-slate-200">
      ...
      <section className="bg-gradient-to-b from-indigo-100/60 via-purple-50/40 to-slate-50/80 dark:from-[#070a10] dark:via-[#070a10] dark:to-[#070a10] py-20 border-y-2 border-indigo-200/80 dark:border-slate-800/80">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                    {['Rafi', 'Rahim', 'Karim', 'Hasan'].map((m) => (
                      <div key={m} className="p-3.5 bg-gradient-to-b from-indigo-100/70 to-white dark:from-slate-900 dark:to-slate-900 rounded-xl text-center border-2 border-indigo-200 dark:border-slate-800 font-mono text-xs shadow-sm hover:border-indigo-400 transition-all">
                        <div className="font-bold text-slate-800 dark:text-slate-200">{m}</div>
                        <div className="text-indigo-700 dark:text-indigo-400 font-extrabold mt-1">৳1,000.00</div>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                    {[
                      ...
                      <div key={item.name} className="p-3.5 bg-gradient-to-b from-emerald-100/70 to-white dark:from-slate-900 dark:to-slate-900 rounded-xl text-center border-2 border-emerald-200 dark:border-slate-800 font-mono text-xs shadow-sm hover:border-emerald-400 transition-all">
                        <div className="font-bold text-slate-800 dark:text-slate-200">{item.name}</div>
                        <div className="text-emerald-700 dark:text-emerald-400 font-extrabold mt-1">{item.amt}</div>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                    {[
                      ...
                      <div key={item.name} className="p-3.5 bg-gradient-to-b from-amber-100/70 to-white dark:from-slate-900 dark:to-slate-900 rounded-xl text-center border-2 border-amber-200 dark:border-slate-800 font-mono text-xs shadow-sm hover:border-amber-400 transition-all">
                        <div className="font-bold text-slate-800 dark:text-slate-200">{item.name}</div>
                        <div className="text-amber-800 dark:text-amber-400 font-extrabold mt-1">{item.amt}</div>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="grid grid-cols-3 gap-3 pt-2">
                    {[
                      ...
                      <div key={item.name} className="p-3.5 bg-gradient-to-b from-purple-100/70 to-white dark:from-slate-900 dark:to-slate-900 rounded-xl text-center border-2 border-purple-200 dark:border-slate-800 font-mono text-xs shadow-sm hover:border-purple-400 transition-all">
                        <div className="font-bold text-slate-800 dark:text-slate-200">{item.name}</div>
                        <div className="text-purple-700 dark:text-purple-400 font-extrabold mt-1">{item.amt}</div>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <div className="space-y-3.5">
          {faqs.map((faq, i) => (
            ...
            >
              ...
              {activeFaq === i && (
                <div className="px-5 pb-5 text-sm text-slate-700 dark:text-slate-300 leading-relaxed border-t border-indigo-100 dark:border-slate-800/80 pt-3.5 bg-gradient-to-b from-indigo-50/20 to-white dark:from-transparent dark:to-transparent">
                  {faq.a}
                </div>
              )}
            </div>
