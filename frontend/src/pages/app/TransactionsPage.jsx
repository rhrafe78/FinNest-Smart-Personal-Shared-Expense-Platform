...
export const TransactionsPage = () => {
  ...
  const handleExportCSV = async () => {
    ...
    try {
      ...
      alert('CSV ডাউনলোড করা যায়নি। অনুগ্রহ করে আবার চেষ্টা করুন।');
    } finally {
      setExporting(false);
    }
  };
  ...
  const filterTabs = [
    { label: 'সব লেনদেন', value: '' },
    { label: 'ব্যক্তিগত খরচ', value: 'expense' },
    { label: 'আয়', value: 'income' },
    { label: 'মেসের খরচ', value: 'shared_expense' },
  ];
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">
            আপনার ব্যক্তিগত আয়, ব্যয় ও মেসের খরচের সম্পূর্ণ পরিচ্ছন্ন হিসাব।
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <form onSubmit={handleSearchSubmit} className="relative flex-1 sm:w-64">
              <input
                type="text"
                placeholder="দোকান বা বিবরণ দিয়ে খুঁজুন..."
                value={search}
          ...
          <div className="p-16 text-center space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-500 max-w-sm mx-auto">
                আপনার হিসাব খাতা একদম ফ্রেশ! নতুন খরচ বা আয় যোগ করতে নিচের বোতাম ব্যবহার করুন।
              </p>
            </div>
                  ...
                  <div className="flex items-center gap-3.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                        ...
                        <span>•</span>
                        <span>{tx.payment_method || 'ক্যাশ'}</span>
                        <span>•</span>
                    ...
                    <div className="text-right">
                      ...
                      {isShared && tx.user_share && tx.user_share !== tx.amount && (
                        <div className="text-[10px] text-slate-400 font-normal">
                          আপনার ভাগ: {curr} {parseFloat(tx.user_share).toLocaleString('en-US', { minimumFractionDigits: 2 })}
                        </div>
                      )}
                    </div>
